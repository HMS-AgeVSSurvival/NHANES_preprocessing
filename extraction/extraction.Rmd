...
write_feather(variables_laboratory, "./raw_data/variables_laboratory.feather")
write_feather(files_laboratory, "./raw_data/files_laboratory.feather")
write_feather(variables_examination, "./raw_data/variables_examination.feather")
write_feather(files_examination, "./raw_data/files_examination.feather")
```
...
for (i in 1:length(cleaned_cycle_examination)){
  ...
  nhanes_load_data(cleaned_data_file_name_examination[i], cleaned_cycle_examination[i], destination = "~/HMS/NHANES_preprocessing/extraction/raw_data/examination/")
}
```
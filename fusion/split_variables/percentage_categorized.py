...
if __name__ == "__main__":
    ...
    for main_category in ["examination", "laboratory", "demographics", "questionnaire"]:
        ...
        unique_variable_main_category = variable_main_category["variable_name"].drop_duplicates()

        categorized_from_main_category = unique_variable_main_category.isin(variable_description["variable"]).sum()

        print(f"Percentage categorized in {main_category}", 100 * categorized_from_main_category / len(unique_variable_main_category))
